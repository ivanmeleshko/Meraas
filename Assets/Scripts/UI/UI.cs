...
public class UI : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            float delta = Input.GetAxis("Mouse ScrollWheel") * sensitivity;
            RectTransform panelRectTransform = Popup.GetComponent<RectTransform>();

            if (panelRectTransform.sizeDelta.y >= 200f && panelRectTransform.sizeDelta.y <= 2000f)
            {
                //
            }
        }
